...
public class BitmapControl {
    ...
    Bitmap upTube;
    Bitmap downTube;
    Bitmap upColoredTube;
    Bitmap downColoredTube;

    public BitmapControl(Resources res) {
        background = BitmapFactory.decodeResource(res, R.drawable.background);
        background = imageScale(background);
        FlyingBird = new Bitmap[3];
        FlyingBird[0] = BitmapFactory.decodeResource(res, R.drawable.bird);
        FlyingBird[1] = BitmapFactory.decodeResource(res, R.drawable.bird1);
        FlyingBird[2]= BitmapFactory.decodeResource(res,R.drawable.bird);
        upTube=BitmapFactory.decodeResource(res,R.drawable.up);
        downTube=BitmapFactory.decodeResource(res,R.drawable.down);
    ...
    public Bitmap getUpColoredTube(){return upColoredTube;}
    public Bitmap getDownColoredTube(){return downColoredTube;}
